...
exports.survey_create = async (req, res) => {
  let countrySelect;
...
exports.survey_filtered_by_created_user = async (req, res) => {
  try {
...
exports.survey_delete = async (req, res) => {
  try {
...
//survey approve
exports.survey_creator_approve = async (req, res) => {
  try {
...
//reject
//survey approve
exports.survey_creator_reject = async (req, res) => {
  try {
    const survey = await Survey.findOneAndUpdate(
      {
        user: req.user._id,
...
//user survey by id
exports.survey_by_id_created_user = async (req, res) => {
  try {
    const survey = await Survey.findOne({
      _id: req.params.id,
      user: req.user._id,
...
exports.survey_by_id_user = async (req, res) => {
  try {
    const survey = await Survey.findOne({
      _id: req.params.id,
    }).populate(["country", "state", "language"]);
...
//survey accept
//survey responsoe
exports.survey_accept_user = async (req, res) => {
  try {
    const survey = await Survey.findOne({
      _id: req.params.id,
    }).populate(["country", "state", "language"]);
...
//survey responsoe
exports.survey_response_submit_user = async (req, res) => {
  try {
    const survey = await Survey.findOneAndUpdate(
      {
        _id: req.params.id,
...
//suser survey return
exports.survey_return_user = async (req, res) => {
  try {
    const survey = await Survey.findOneAndUpdate(
      {
        _id: req.params.id,
...
//survey abond
exports.survey_abandon_user = async (req, res) => {
  try {
    const surveys = await Survey.findOneAndUpdate(
      {
        _id: req.params.id,
...
//suser survey return
exports.survey_exit_by_force_created_user = async (req, res) => {
  try {
    const survey = await Survey.findOne({
      _id: req.params.id,
      user: req.user._id,
...
exports.survey_list_user = async (req, res) => {
  try {
...
exports.survey_approve_all = async (req, res) => {
  try {
    const survey = await Survey.findOne({
      _id: req.params.id,
      user: req.user._id,
